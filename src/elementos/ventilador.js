 ...
 *  - CON proteccion: grilla/guarda circular de acero en la cara de entrada (foto real AESA).
...
export const meta = {
  ...
  descripcion: 'Ventilador axial. Variante con guarda protectora (grilla circular, como en foto AESA) o sin guarda (aspas expuestas).'
};
...
export function crear({ conPatas = true, radio = 0.6, conProteccion = false } = {}) {
  ...
  const mAcero   = MineMaterials.acero();
